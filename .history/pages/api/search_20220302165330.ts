...
// I'm sure there's a way to write this once for gql and ts. Would love to explore that further
type CarbonRemoval = {
  id: string;
  project_name: string;
  quantity: number;
...
const resolvers = {
  Query: {
    async search(parent, args, context) {
      ...
      itemsData<CarbonRemoval>.sort(function(a: CarbonRemoval, b: CarbonRemoval) {
